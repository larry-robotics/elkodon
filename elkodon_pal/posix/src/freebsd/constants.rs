...
pub const PTHREAD_MUTEX_RECURSIVE: int =
    crate::internal::pthread_mutextype_PTHREAD_MUTEX_RECURSIVE as _;
pub const PTHREAD_MUTEX_ERRORCHECK: int =
    crate::internal::pthread_mutextype_PTHREAD_MUTEX_ERRORCHECK as _;
