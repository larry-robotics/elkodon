...
//! use elkodon_bb_memory::bump_allocator::*;
//!
...
pub use elkodon_bb_elementary::allocator::BaseAllocator;
use elkodon_bb_elementary::allocator::{AllocationError, DeallocationError};
