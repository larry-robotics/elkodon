    ...
    {$(#[$documentation:meta])*
     ...
     comparision: $comparision:expr} => {
        ...
        pub struct $string_name {
            value: elkodon_bb_container::byte_string::FixedSizeByteString<$capacity>
        }

        impl $string_name {
            pub const unsafe fn new_unchecked(bytes: &[u8]) -> Self {
                Self {
                    value: elkodon_bb_container::byte_string::FixedSizeByteString::new_unchecked(bytes),
                }
            }
        ...
        impl elkodon_bb_container::semantic_string::SemanticStringAccessor<$capacity> for $string_name {
            unsafe fn new_empty() -> Self {
                Self {
                    value: elkodon_bb_container::byte_string::FixedSizeByteString::new(),
                }
            }

            fn as_string(&self) -> &elkodon_bb_container::byte_string::FixedSizeByteString<$capacity> {
                &self.value
            }

            unsafe fn get_mut_string(&mut self) -> &mut elkodon_bb_container::byte_string::FixedSizeByteString<$capacity> {
                &mut self.value
            }
        ...
        impl elkodon_bb_container::semantic_string::SemanticString<$capacity> for $string_name {}
    };
}
