...
mod dynamic_storage {
    ...
    use elkodon_bb_elementary::math::ToB64;
    ...
    #[instantiate_tests(<elkodon_cal::dynamic_storage::posix_shared_memory::Storage<TestData>>)]
    mod posix_shared_memory {}

    #[instantiate_tests(<elkodon_cal::dynamic_storage::process_local::Storage<TestData>>)]
    mod process_local {}
}
