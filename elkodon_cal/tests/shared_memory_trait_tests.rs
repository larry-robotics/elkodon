...
mod shared_memory {
    ...
    #[instantiate_tests(<elkodon_cal::shared_memory::posix::Memory<DefaultAllocator>>)]
    mod posix {}

    #[instantiate_tests(<elkodon_cal::shared_memory::process_local::Memory<DefaultAllocator>>)]
    mod process_local {}
}
