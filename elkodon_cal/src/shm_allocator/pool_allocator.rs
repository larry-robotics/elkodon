...
use elkodon_bb_elementary::allocator::{BaseAllocator, DeallocationError};
...
pub struct PoolAllocator {
    allocator: elkodon_bb_memory::pool_allocator::PoolAllocator,
...
impl ShmAllocator for PoolAllocator {
    ...
    fn management_size(memory_size: usize, config: &Self::Configuration) -> usize {
        elkodon_bb_memory::pool_allocator::PoolAllocator::memory_size(
    ...
    unsafe fn new_uninit(
        ...
        Self {
            allocator: elkodon_bb_memory::pool_allocator::PoolAllocator::new_uninit(
                config.bucket_layout,
